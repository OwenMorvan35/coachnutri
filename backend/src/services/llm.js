...
export const buildSystemPrompt = (profile) => {
  return [
    ...
    '',
    'Contexte application CoachNutri :',
    '- Onglet « Coach » : discussion directe avec toi (NutrIA).',
    '- Onglet « Recettes » : bibliothèque personnelle et import depuis le chat.',
    '- Onglet « Suivi » : suivi du poids avec graphique, filtres Jour/Semaine/Mois/Année et bouton « Ajouter mon poids ».',
